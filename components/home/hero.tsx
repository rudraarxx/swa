...
export function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative h-screen w-full overflow-hidden bg-black font-sans selection:bg-white selection:text-black"
    >
      {/* Cinematic Gallery */}
          ...
          >
            ...
            >
              <Image
                ...
                unoptimized={currentProject.featuredImage?.includes(
                  "drive.google.com",
                )}
              />
      ...
      <div
        className="pointer-events-none absolute inset-0 z-10 opacity-20 contrast-[1.1]"
      ...
      >
        ...
        <div className="mb-6 md:mb-8 max-w-5xl">
          ...
          <CharacterReveal
            ...
            className="text-3xl sm:text-5xl leading-[0.9] font-extralight tracking-tighter text-white"
          />
        ...
        <Link href={`/projects/${currentProject.slug}`}>
          <motion.div
            ...
            className="absolute bottom-32 md:bottom-40 right-6 md:right-16 flex flex-col items-center gap-3 md:gap-4 z-30 cursor-pointer group"
          >
            <MagneticCursor strength={0.3}>
              <div className="group relative flex h-16 w-16 md:h-20 md:w-20 items-center justify-center rounded-full border border-white/20 text-white transition-colors hover:bg-white hover:text-black">
            ...
            <span className="font-mono text-[9px] md:text-[10px] tracking-widest text-white/50 origin-center">
              EXPLORE
            </span>
          </motion.div>
        </Link>
